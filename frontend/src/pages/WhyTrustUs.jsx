          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {stories.map((s, i) => (
              <motion.div
                ...
                viewport={{ once: true }}
                variants={fadeUp}
                className={`bg-linear-to-br ${s.gradient} border ${s.border} rounded-2xl p-7 hover:shadow-lg hover:-translate-y-1 transition-all duration-300 group`}
              >
                <div className="flex items-start gap-4 mb-4">
                  ...
                  <div className="flex-1">
                    ...
                    <span className={`text-xs px-2.5 py-1 ${s.tag} font-semibold rounded-full`}>
                      {s.category}
                    </span>
                  </div>
