    ...
    <div className="space-y-6">
      ...
      <div className="flex gap-3">
        <button
          ...
          className={`px-4 py-2 rounded ${filter === "pending" ? "bg-emerald-600 text-white" : "bg-gray-200"}`}
        >
          Pending
        </button>
        <button
          onClick={() => setFilter("all")}
          className={`px-4 py-2 rounded ${filter === "all" ? "bg-emerald-600 text-white" : "bg-gray-200"}`}
        >
          All Campaigns
        </button>
      </div>
